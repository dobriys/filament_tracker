...
- **Уведомления в Telegram** — сообщения об изменениях состояния принтера и склада.
  Создайте бота через [@BotFather](https://t.me/BotFather), укажите токен и chat id
  (подскажет [@userinfobot](https://t.me/userinfobot)), нажмите «Отправить тест» —
  и отметьте галочками, что именно вам нужно:
